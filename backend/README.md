...
## Project Structure
    ...
    ├── purple_waterfall_de_71987  # Django project configurations
...
1. Clone this repo and `cd purple_waterfall_de_71987`
...
2. Clone this repo and `cd purple_waterfall_de_71987`
